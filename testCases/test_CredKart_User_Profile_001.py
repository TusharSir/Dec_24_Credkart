...
class Test_User_Profile_Class_001:
    ...
    # Use all decorators in allure report
    """Test cases for the UserProfile class."""
    @allure.description("Validating the CredKart URL")
    @allure.title("TC_001 : Validating the CredKart URL")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.story("Story : Week3")
    @allure.epic("Epic : 2nd level")
    @pytest.mark.sanity
    @pytest.mark.group1
    ...
    def test_verify_CredKart_Url_001(self):
        ...
        if self.driver.title == "CredKart":
            ...
            allure.attach.file(".\\Screenshots\\test_verify_CredKart_Url_001_Pass.png",
                               name="test_verify_CredKart_Url_001_Pass.png", attachment_type=allure.attachment_type.PNG
                               )
            ...
            allure.attach.file(".\\Screenshots\\test_verify_CredKart_Url_001_Fail.png",
                               name="test_verify_CredKart_Url_001_Fail.png", attachment_type=allure.attachment_type.PNG
                               )
